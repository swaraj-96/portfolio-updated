...
const ProjectDescription = ({projectDescription}) => {
  return (
    <div className="container-max px-4 mt-8 sm:flex">
        <div className="sm:w-1/2 px-2 space-y-2 items-center mb-4 sm:mb-0">
          <h1 className="font-bold text-xl text-blue-800">
            Project Description
          </h1>
          <p className='dark:text-gray-400'>{projectDescription.info || projectDescription}</p>
        </div>
        <div className="sm:w-1/2 px-2 space-y-2 items-center">
